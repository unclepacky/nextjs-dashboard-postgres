import { addExtensionToContract, updateExtension } from '@/app/lib/actions';
...
export default async function EditExtensionPage({
  params,
}: {
  params: { id: string };
}) {
  ...
  const handleUpdateExtension = updateExtension.bind(null, params.id);

  return (
    <form action={handleUpdateExtension}>
              ...
              <div className="flex flex-1 flex-col justify-start">
                ...
                <div className="relative mb-4">
                  <ExtensionInput
                    ...
                    placeholder=""
                    defaultValue={
                      extension?.startDate.toISOString().split('T')[0]
                    }
                    icon={<UserCircleIcon />}
                  />
                </div>
                ...
                <div className="relative mb-4">
                  <ExtensionInput
                    ...
                    placeholder=""
                    defaultValue={
                      extension?.endDate.toISOString().split('T')[0]
                    }
                    icon={<UserCircleIcon />}
                  />
                </div>
