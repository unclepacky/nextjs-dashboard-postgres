  ...
  return (
    ...
    >
      <nav
        ...
        role="navigation"
        className="mx-auto my-0 flex max-w-[1200px] flex-nowrap justify-between"
      >
        <div className="flex w-full items-center justify-between gap-[20px]">
          <div
            className="flex flex-initial flex-row items-center justify-start gap-[12px]"
            data-version="v1"
          >
            ...
            <div>
              <p className="whitespace-nowrap" data-version="v1">
                © 2024{' '}
              </p>
            </div>
          </div>
          <a
            ...
            className="link_link__hbWKh status-indicator_link__Asin1"
          >
            <div className="status-indicator_content__H99ii status-indicator_noBorder__2bBKp">
              <span
                className="status-indicator_indicator__IVv6X"
                data-testid="footer/status/success"
              ></span>
              <small className="geist-themed geist-success geist-ellipsis geist-text small w-500">
                All systems normal.
              </small>
            </div>
          </a>
          <button
            className="footer_cmdk__AZTR4"
            data-testid="footer/cmdk"
            type="button"
          >
            Command Menu{' '}
            <kbd
              className="kbd_kbd__Ns1jh kbd_small__jiryA"
              data-geist-kbd=""
              data-version="v1"
            >
              <span>⌘</span>
      ...
      <section>
        <ul className="footer_dashboardFooterLinks__ssDUW">
          ...
          <li className="footer_item__tMf_5">
            <a className="link_link__hbWKh link_secondary__F1rqx" href="/home">
              Home
            </a>
          </li>
          <li className="footer_item__tMf_5">
            <a className="link_link__hbWKh link_secondary__F1rqx" href="/docs">
              Documentation
            </a>
          </li>
          <li className="footer_item__tMf_5">
          ...
          <li className="footer_item__tMf_5">
            <a className="link_link__hbWKh link_secondary__F1rqx" href="/help">
              Help
            </a>
          </li>
          <li className="footer_item__tMf_5">
          ...
          <li className="footer_item__tMf_5">
            <a className="link_link__hbWKh link_secondary__F1rqx" href="/blog">
              Blog
            </a>
          </li>
          <li className="footer_item__tMf_5">
          ...
          <button
            ...
            aria-haspopup="true"
            aria-expanded="false"
            aria-controls="menu-:rh:"
            data-testid="footer/legal-button"
            aria-label="Menu"
            data-geist-menu-button=""
            data-is-open="false"
            id="menu-button-:ri:"
            className="button_base__BjwbK reset_reset__KRyvc"
            data-geist-button=""
            data-prefix="false"
            data-suffix="false"
            data-version="v1"
          >
            <span className="button_content__1aE1_ button_flex__fCY56 button_center__nyfP_">
              <span className="flex w-full items-center gap-[2px]">
                Legal
                <svg
                  height="16"
                  strokeLinejoin="round"
